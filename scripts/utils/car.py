...
class SimpleCar:
    ...
    def __init__(self, env, start_pos=None, end_pos=None, l=1, max_phi=pi/5):
        ...
        self.carl = SimpleCar.CAR_LENGTH
        self.carw = SimpleCar.CAR_WIDTH
    ...
    def get_car_bounding(self, pos):
        ...
        self.c1 = transform(x, y, self.carl/2, self.carw/2, theta, 1)
        self.c2 = transform(x, y, self.carl/2, self.carw/2, theta, 2)
        self.c3 = transform(x, y, self.carl/2, self.carw/2, theta, 3)
        self.c4 = transform(x, y, self.carl/2, self.carw/2, theta, 4)
    ...
    def get_car_state(self, pos, phi=0):
        ...
        self.w3 = transform(x, y, 0, 0.5*self.l, theta, 3)
        self.w4 = transform(x, y, 0, 0.5*self.l+self.whlw, theta, 4)
